...
print("**********************************************")
print("Project Title  --Kidney Tumor Detection ")
print("**********************************************")
print()
...
tf.keras.models.save_model(model,'kidneymodel.h5')
...
plt.show()
import tensorflow as tf
model = tf.keras.models.load_model('kidneymodel.h5')
#=================================Prediction===================================
