...
print("**********************************************")
print("Project Title  --Breast Tumor Detection ")
print("**********************************************")
print()
...
#==============================Input Data======================================
path = 'Dataset/Breast Cancer/'

# categories
categories = ['breast_benign','breast_malignant']
...
tf.keras.models.save_model(model,'breastmodel.h5')
...
plt.show()
import tensorflow as tf
model = tf.keras.models.load_model('breastmodel.h5')
#=================================Prediction===================================
